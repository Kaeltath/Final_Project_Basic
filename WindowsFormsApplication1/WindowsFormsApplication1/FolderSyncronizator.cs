...
namespace WindowsFormsApplication1
{
    public class FoldersSynchronizator
    {
        ...
        public event EventHandler<WindowsFormsApplication1.SyncronizationController.SynchronizationEventArgs> OnAppliedChangeEventEventHandler;
        public event EventHandler<WindowsFormsApplication1.SyncronizationController.SynchronizationEventArgs> OnSkippedChangeEventEventHandler;
        ...
        private void FolderSynchronizator_OnAppliedChangeEventHandler(object sender, AppliedChangeEventArgs args)
        {
            ...
            {
                OnAppliedChangeEventEventHandler(this, new WindowsFormsApplication1.SyncronizationController.SynchronizationEventArgs(message));
            }
        }
        ...
        public void FolderSynchronizator_OnSkippedChangeEventHandler(object sender, SkippedChangeEventArgs args)
        {
            ...
            {
                OnSkippedChangeEventEventHandler(this, new WindowsFormsApplication1.SyncronizationController.SynchronizationEventArgs(message));
            }
        }
